...
VERIFIED_PROGRAMS: tuple[VerifiedAffiliateProgram, ...] = (
    VerifiedAffiliateProgram(
        ...
        notes=["Commission varies by product and partner tier."],
    ),
    VerifiedAffiliateProgram(
    ...
    VerifiedAffiliateProgram(
        ...
        program_url="https://www.hostinger.com/pk/horizons/affiliate-program",
        network="direct",
        commission_text="Up to 60% commission on eligible initial Horizons purchases.",
        ...
        notes=[
            ...
            "Specific offers and commission levels can vary.",
        ],
    ),
    VerifiedAffiliateProgram(
